PROXY_URLS=("https://github.com/proxifly/free-proxy-list/raw/refs/heads/main/proxies/protocols/http/data.txt" "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text")
